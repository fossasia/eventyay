...
if os.path.exists(os.path.abspath('../src/eventyay/static/fonts/')):
    html_static_path.append(os.path.abspath('../src/eventyay/static/fonts/'))
if os.path.exists(os.path.abspath('../src/eventyay/static/fontawesome/fonts/')):
    html_static_path.append(os.path.abspath('../src/eventyay/static/fontawesome/fonts/'))
