# This Dockerfile is for Render.com deployment
# It sets the build context to the app directory and uses the app/Dockerfile
...
RUN EVY_SECRET_KEY=build_dummy \
    ...
    EVY_SITE_URL=https://eventyay-next-web.onrender.com \
