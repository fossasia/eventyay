...
def eventyaycontrol_logentry_display(sender: Event, logentry: LogEntry, **kwargs):
    ...
    plains = {
        ...
        'eventyay.event.quota.added': _('The capacity has been added.'),
        'eventyay.event.quota.deleted': _('The capacity has been deleted.'),
        'eventyay.event.quota.changed': _('The capacity has been changed.'),
        'eventyay.event.quota.closed': _('The capacity has closed.'),
        'eventyay.event.quota.opened': _('The capacity has been re-opened.'),
        ...
        'eventyay.subevent.quota.added': pgettext_lazy('subevent', 'A capacity has been added to the event date.'),
        'eventyay.subevent.quota.changed': pgettext_lazy('subevent', 'A capacity has been changed on the event date.'),
        'eventyay.subevent.quota.deleted': pgettext_lazy('subevent', 'A capacity has been removed from the event date.'),
