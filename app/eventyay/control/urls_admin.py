...
urlpatterns = [
    ...
    path('global/settings/country-fees/add/', global_settings.TicketFeeCountryCreateView.as_view(), name='admin.global.settings.country_fee.add'),
    path('global/settings/country-fees/<int:pk>/delete/', global_settings.TicketFeeCountryDeleteView.as_view(), name='admin.global.settings.country_fee.delete'),
