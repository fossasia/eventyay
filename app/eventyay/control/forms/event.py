...
class EventWizardBasicsForm(I18nModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['geo_lat'].widget.attrs['placeholder'] = _('e.g., 40.7128 (between -90 and 90)')
        self.fields['geo_lon'].widget.attrs['placeholder'] = _('e.g., -74.0060 (between -180 and 180)')
