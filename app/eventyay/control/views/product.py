    ...
    def post(self, request, *args, **kwargs):
        ...
        if field == 'required':
            ...
            if value is None or not isinstance(value, bool):
                return JsonResponse({'error': 'Value must be a boolean for required field'}, status=400)
            ...
            if value is None or not isinstance(value, bool):
                return JsonResponse({'error': 'Value must be a boolean for active field'}, status=400)
