...
class SubmissionImportProcessView(EventPermissionRequired, AsyncAction, FormView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        try:
            ...
            return redirect(self._import_redirect_url)
        return super().dispatch(request, *args, **kwargs)
    ...
    def get_success_url(self, value):
        if self._import_redirect_url != self.request.event.orga_urls.submissions_import:
            return self._import_redirect_url
        return self.request.event.orga_urls.submissions
