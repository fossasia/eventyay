...
class MailSettingsForm(ReadOnlyFlag, I18nFormMixin, I18nHelpText, JsonSubfieldMixin, forms.Form):
    """
    Talks-component email settings.

    SMTP configuration is shared across all components and is managed under
    Event Settings › Email. This form covers only Talks-specific settings:
    reply-to address, subject prefix, and mail signature.
    """
