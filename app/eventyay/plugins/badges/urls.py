...
urlpatterns = [
    ...
    path(
        'control/event/<orgslug:organizer>/<slug:event>/orders/<str:code>/position/<int:position>/badges/preview/',
        BadgeDownloadPreviewView.as_view(),
