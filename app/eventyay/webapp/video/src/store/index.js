...
export default new Vuex.Store({
	...
	actions: {
		...
		async changeRoom({state, dispatch}, room) {
			...
			if (room?.modules.some(module => ['livestream.native', 'livestream.youtube', 'livestream.iframe', 'call.bigbluebutton', 'call.zoom', 'call.janus', 'call.jitsi', 'call.loungemesh'].includes(module.type))) {
				try {
