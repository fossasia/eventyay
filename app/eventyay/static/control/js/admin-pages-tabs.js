 ...
 */
import { initAllLanguageGrids } from '../../eventyay-common/js/language-grid.js';
...
async function navigate(url, push) {
    ...
    try {
        ...
        newContent.dispatchEvent(
            new CustomEvent('eventyay:ajax-results-replaced', { bubbles: true })
        );
        if (push) {
