...
class CRUDView(PaginationMixin, Filterable, View):
    ...
    def has_permission(self, permission, generic=False):
        ...
        return self.request.user.has_perm(permission, permission_object) or check_admin_mode(self.request)
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.object:
            ...
            kwargs['has_update_permission'] = self.request.user.has_perm(self.model.get_perm('update'), self.object) or check_admin_mode(self.request)
            kwargs['has_delete_permission'] = self.request.user.has_perm(self.model.get_perm('delete'), self.object) or check_admin_mode(self.request)
            ...
            ) or check_admin_mode(self.request)
