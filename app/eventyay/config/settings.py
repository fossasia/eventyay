...
# Fernet key strings for encrypting OAuth client secrets in global settings.
# When empty, secrets derive encryption from SECRET_KEY (development only).
SOCIALAUTH_SECRET_ENCRYPTION_KEYS = ()
