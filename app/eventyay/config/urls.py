...
from eventyay.consts import STRIPE_WEBHOOK_LEGACY_PATH
...
base_patterns = [
    ...
    # TODO (#2463): Remove this alias once the Stripe dashboard endpoint has been updated
    #               to the canonical path /api/v1/webhook/stripe.
    path(STRIPE_WEBHOOK_LEGACY_PATH, stripe_webhook_view, name='stripe-webhook-legacy'),
