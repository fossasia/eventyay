...
base_patterns = [
    ...
    # Legacy Stripe webhook path — Stripe dashboard sends events here.
    # Alias kept for backward compatibility; canonical path is /api/v1/webhook/stripe.
    path('_stripe/webhook', stripe_webhook_view, name='stripe-webhook-legacy'),
